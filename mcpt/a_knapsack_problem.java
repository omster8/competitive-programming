...
<head>
    ...
    <meta property="og:url"
          content="http://mcpt.ca/accounts/login/?next=/src/14849/raw">
    <!--[if lt IE 9]>
    ...
    <link rel="canonical"
          href="http://mcpt.ca/accounts/login/?next=/src/14849/raw">
    <style>
        #login-panel {
...
<input type='hidden' name='csrfmiddlewaretoken' value='ENF5W5rAMur9ZyfkF4WCyu6IjFtxUrAEOe8QrF8DMELrYpw30gJiLMG8SWJv13Aa' />            <table border="0" style="text-align:left">
                <tr>
            ...
            <input type="hidden" name="next" value="/src/14849/raw">
        </form>
...
<input type='hidden' name='csrfmiddlewaretoken' value='ENF5W5rAMur9ZyfkF4WCyu6IjFtxUrAEOe8QrF8DMELrYpw30gJiLMG8SWJv13Aa' />            <input name="next" type="hidden" value="/accounts/login/?next=/src/14849/raw">
